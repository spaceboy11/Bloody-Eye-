...
.....''''..........,:ld;
 ...
 .                   OMo           ':ddo.
          ...
          print("\n"+Fore.RED+" ["+Fore.WHITE+"~"+Fore.RED+"]"+" URL 1 : "+Fore.BLUE+str(a).replace('"','').replace("NgrokTunnel:","").replace("http","https").replace("-> https://localhost:6060",""))
          print("\n"+Fore.RED+" ["+Fore.WHITE+"~"+Fore.RED+"]"+" URL 2 : "+Fore.BLUE+str(a).replace('"','').replace("NgrokTunnel:","").replace("-> http://localhost:6060",""))
       except:
